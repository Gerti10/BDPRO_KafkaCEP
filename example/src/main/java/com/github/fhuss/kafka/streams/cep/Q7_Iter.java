...
public class Q7_Iter {

    private static final Logger LOG = LoggerFactory.getLogger(Q7_Iter.class);
    ...
    public static void main(String[] args) {
        ...
        streamsConfiguration.put(StreamsConfig.CLIENT_ID_CONFIG, "stocks-demo");
        ...
        Topology topology = Q7_Iter.topology("velocities", "velocities", "Matches");
